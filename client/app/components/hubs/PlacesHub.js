'use client';
import { Store, MapPin, Network, Settings } from 'lucide-react';
...
// cafe → branch → people org tree, and Settings (org configuration) rides along
...
const TABS = [
  ...
  { key: 'settings', label: 'Settings', icon: Settings, pageKey: 'page_settings', render: () => <SettingsPage /> },
];
