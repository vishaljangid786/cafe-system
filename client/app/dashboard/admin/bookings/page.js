...
import { CalendarDays, CheckCircle, XCircle, Clock, Users, MapPin, Loader2 } from 'lucide-react';
        ...
        <SlideIn direction="down">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm font-medium mt-1">Manage cafe reservations and capacity</p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="relative">
                ...
                <select
                  ...
                  className="pl-10 pr-10 py-2.5 bg-white dark:bg-zinc-900 border border-border rounded-xl text-sm font-bold shadow-sm focus:ring-2 focus:ring-amber-500 outline-none appearance-none"
                >
