      ...
      <div className="p-6 lg:p-10 max-w-5xl mx-auto space-y-10">
        ...
        <SlideIn>
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-4xl font-black text-[var(--color-text-primary)] flex items-center gap-3">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-[var(--color-surface)] rounded-[2.5rem] border border-[var(--color-border)] p-8 shadow-sm">
            ...
            <div className="bg-[var(--color-surface)] rounded-[2.5rem] border border-[var(--color-border)] p-8 shadow-sm grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            <div className="bg-[var(--color-surface)] text-[var(--color-text-primary)] rounded-[2.5rem] p-8 shadow-2xl relative overflow-hidden h-full flex flex-col justify-between border border-[var(--color-border)]">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[var(--color-primary)]/20 blur-3xl -mr-16 -mt-16 rounded-full" />
              
              <div className="space-y-8 relative z-10">
                <h2 className="text-xs font-black uppercase tracking-widest text-[var(--color-text-muted)]">2. Delivery Format</h2>
              ...
              <div className="pt-8 relative z-10">
                <button
                  ...
                  disabled={loading}
                  className="w-full py-5 bg-[var(--color-primary)] hover:bg-[var(--color-secondary)] disabled:bg-[var(--color-surface-soft)] text-white font-black uppercase tracking-widest rounded-3xl transition-all shadow-xl shadow-[var(--color-primary)]/20 flex items-center justify-center gap-3 active:scale-95"
                >
                  {loading ? (
                    <>
