    ...
    <PageTransition>
      <div className="space-y-6 pb-10">
        ...
        <div className="space-y-4">
          <h3 className="text-[11px] font-medium uppercase tracking-normal text-(--color-text-muted) ml-1">Recent Income</h3>
          {refetching ? (
            <div className="space-y-4">
            ...
            <div className="py-10 text-center bg-white/40 dark:bg-(--color-bg)/40 rounded-xl border border-dashed border-(--color-border) dark:border-(--color-border)">
              <p className="text-(--color-text-muted) font-medium">No revenue found.</p>
            </div>
          ) : (
